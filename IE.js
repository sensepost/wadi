...
CSS2EffectInterface = {
	...
	'Attributes':[
		...
		['transitionProperty',['none','all','initial','inherit',function() {return ra(CSS3SheetsPropertiesInterface.Attributes)[0]}]],
		...
		['transition',[function() {return arrayWalk(['none','all',function() {return ra(CSS3SheetsPropertiesInterface.Attributes)[0]}])+" "+timeValue()+" "+arrayWalk(['linear','ease','ease-in','ease-out','ease-in-out',function() {return 'cubic-bezier('+floatValue()+","+floatValue()+","+floatValue()+","+floatValue()+")"},''])+ " "+ra([timeValue(),''])},'initial','inherit']],
...
CSS2PropertiesInterface = {
	...
	'Attributes':[
		["azimuth",[angleValue,'left-side','far-left','left','center-left','center','center-right','right','far-right','right-side','behind left-side','behindfar-left','behind left','behind center-left','behind center','behind center-right','behind right','behind far-right','behind right-side','behind leftwards','behind rightwards','inherit','']],
		["background",[backgroundAtrribute,""]],//,function () { return string(rint(STR_NUM))},randoms,"url('')",'url()'
		["backgroundAttachment",["scroll","fixed","inherit",""]],//,function () { return string(rint(STR_NUM))},randoms
		["backgroundColor",[getRandomColor,""]],//,function () { return string(rint(STR_NUM))},randoms
		["backgroundImage",[function() {return retCSSimageURI(2000)},""]],//,function () { return string(rint(STR_NUM))},randoms,"url('')",'url()'
		["backgroundPosition",[distanceValue,'top','center','bottom','right','left','bottom right','bottom left','bottom center','top right','top left','top center','']],//,function () { return string(rint(STR_NUM))},randoms
		["backgroundRepeat",["repeat","repeat-x","repeat-y","no-repeat","inherit",""]],
		["border",[broderAttributes(),""]],
		["borderCollapse",["collapse","inherit","","separate"]],
		["borderColor",[getRandomColor,"","transparent","inherit"]],
		...
		["cueAfter",[function() {return retCSSmediaURI(2000)},"","inherit"]],
		["cueBefore",[function() {return retCSSmediaURI(2000)},"","inherit"]],
		["cursor",[function() {return retmultiplecurs()},function() {return retcursorURI(1)},'auto','crosshair','pointer','alias','all-scroll','cell','context-menu',"col-resize","copy","default","e-resize","ew-resize","help","move","n-resize","ne-resize","nesw-resize","ns-resize","nw-resize","nwse-resize","no-drop","none","not-allowed","pointer","progress","row-resize","s-resize","se-resize","sw-resize","text","vertical-text","w-resize","wait","zoom-in","zoom-out","initial","inherit"]],//,"grab","grabbing"
		["direction",["ltr","rtl","inherit",""]],
		["display",["inline","block","list-item","run-in","compact","marker","table","inline-table","table-row-group","table-header-group","table-footer-group","table-row","table-column-group","table-column","table-cell","table-caption","none","inherit","","grid",'inline-grid']],
		["elevation",[angleValue,"below","level","above","higher","lower","inherit",""]],
		["emptyCells",["show","hide","inherit",""]],
		["float",["left","right","none","inherit",""]],
		["font",[fontAtrribute,"caption","icon","menu","message-box","small-caption","status-bar","inherit",""]],
		["fontFamily",[returnMultipleFamilies,"","inherit"]],
		["fontSize",["xx-small","x-small","small","medium","large","x-large","xx-large","larger","smaller",distanceValue,distanceValue,"","inherit"]],
		["fontSizeAdjust",[randoms,"none","","inherit"]],
		// ["fontStretch",["normal","wider","narrower","ultra-condensed","extra-condensed","condensed","semi-condensed","semi-expanded","expanded","extra-expanded","ultra-expanded","","inherit"]],
		["fontStyle",["normal","italic","oblique","inherit",""]],
		["fontVariant",["normal","small-caps","inherit",""]],
		["fontWeight",["normal","bold","bolder","lighter","100","200","300","400","500","600","700","800","900","inherit",""]],
		["height",[posdistanceValue2,posdistanceValue2,"inherit","auto",function() {return rint(ra(POS_INT_NUMS))}]],//randoms
		["left",[distanceValue3,distanceValue3,"","inherit","auto",function() {return rint(ra(INT_NUMS))}]],
		["letterSpacing",["normal",distanceValue2,"","inherit",function() {return rint(ra(INT_NUMS))}]],
		["lineHeight",["normal",posdistanceValue1,"","inherit",function() {return rint(ra(POS_INT_NUMS))}]],
		["listStyle",[listStyleAttribute,"","inherit"]],
		...
		["minHeight",[posdistanceValue1,function() {return rint(ra(POS_INT_NUMS))},"","inherit"]],
		["minWidth",[posdistanceValue1,function() {return rint(ra(POS_INT_NUMS))},"","inherit"]],
		["orphans",[function() {return (rint(ra(POS_INT_NUMS))+1)},"","inherit"]],
		["outline",[outlineAttribute,"","inherit"]],
		["outlineColor",[getRandomColor,"invert","","inherit"]],
		["outlineStyle",["none","dotted","dashed","solid","double","groove","ridge","inset","outset","","inherit"]],//,"hidden"
		["outlineWidth",[posdistanceValueblur,"thin","thick","medium","","inherit",'']],//,function() {return rint(ra(POS_INT_NUMS))},
		...
		["widows",[function(){return (rint(ra(POS_INT_NUMS))+1)},"inherit",function(){return (rint(ra(POS_INT_NUMS))+1)},""]],
		["width",[posdistanceValue2,function(){return rint(ra(POS_INT_NUMS))},"auto","","inherit",]],
		["wordSpacing",[distanceValue2,"normal","","inherit",function(){return rint(ra(INT_NUMS))}]],
		["zIndex",[function(){return rint(ra(INT_NUMS))},"","inherit",function(){return rint(ra(INT_NUMS))}]],
		['opacity',[floatValue,'',"initial","inherit"]],
		['backgroundClip',['border-box','padding-box','content-box','initial','inherit','']],
		['backgroundOrigin',['border-box','padding-box','content-box','initial','inherit','']],
		...
		['order',['inherit','initial','',function() {return rint(ra(INT_NUMS))}]],
		['hangingPunctuation',['initial','inherit','','none','first','last','allow-end','force-end']],
		['tabSize',[function() {return rint(ra(POS_INT_NUMS))},'initial','inherit','']],
		['textAlignLast',['auto','left','right','center','justify','start','end','initial','inherit','']],
		['textJustify',['auto','distribute','none','initial','inherit','']],//,'inter-word','inter-ideograph','inter-cluster','kashida','trim'
		['wordBreak',['normal','break-all','initial','inherit','']],//,'keep-all'
		['wordWrap',['normal','break-word','initial','inherit','']],
		...
		['imageResolution',['from-image','from-image snap',function() {return rint(2) ? rint(ra(INT_NUMS))+ra(["dpi","dpcm",""]):randoms()+ra(["dpi","dpcm",""])},function() {return rint(2) ? rint(ra(INT_NUMS))+ra(["dpi","dpcm",""]):randoms()+ra(["dpi","dpcm",""])+" snap"},'']],
		['objectFit',['fill','contain','cover','none','scale-down','']],
		['objectPosition',[distanceValue4,'']],
		['mask',["url(data:image/svg+xml;base64,)",'none','inherit','']],
		['maskType',['luminance','alpha','']],
		['markAfter',[function() {return string(rint(STR_NUM))},function() {return ra([returnRandomElement(),ra(createdText).objName,'createdElements['+ra(createdText).objName+']'])},'']],
		['markBefore',[function() {return string(rint(STR_NUM))},function() {return ra([returnRandomElement(),ra(createdText).objName,'createdElements['+ra(createdText).objName+']'])},'']],
		['mark',[function() {return arrayWalk([function() { return "'"+string(rint(STR_NUM))+"'"},ra(createdText).objName,returnRandomElement,'createdElements['+ra(createdText).objName+']'])+" "+arrayWalk([function() {return "'"+string(rint(STR_NUM))},returnRandomElement,'createdElements['+ra(createdText).objName+']'])}]],
		['restAfter',[timeValue,'none','x-weak','weak','medium','strong','x-strong','']],
		['restBefore',[timeValue,'none','x-weak','weak','medium','strong','x-strong','']],	
		['rest',[arrayWalk([timeValue,'none','x-weak','weak','medium','strong','x-strong',''])+" "+arrayWalk([timeValue,'none','x-weak','weak','medium','strong','x-strong','']),'']]	,
		['voiceBalance',['left','center','right','leftwards','rightwards','',function() {return rint(ra(INT_NUMS))}]],
...
CSS3SheetsPropertiesInterface = {
	'Name':'CSS3Properties',
	'Attributes':[
		["azimuth",[angleValue,'left-side','far-left','left','center-left','center','center-right','right','far-right','right-side','behind left-side','behindfar-left','behind left','behind center-left','behind center','behind center-right','behind right','behind far-right','behind right-side','behind leftwards','behind rightwards','inherit']],
		["background",[backgroundAtrribute]],//,function () { return string(rint(STR_NUM))},randoms,"url('')",'url()'
		["background-attachment",["scroll","fixed","inherit"]],//,function () { return string(rint(STR_NUM))},randoms
		["background-color",[getRandomColor]],//,function () { return string(rint(STR_NUM))},randoms
		["background-image",[function() {return retCSSimageURI(2000)}]],//,function () { return string(rint(STR_NUM))},randoms,"url('')",'url()'
		["background-position",[distanceValue,'top','center','bottom','right','left','bottom right','bottom left','bottom center','top right','top left','top center']],//,function () { return string(rint(STR_NUM))},randoms
		["background-repeat",["repeat","repeat-x","repeat-y","no-repeat","inherit"]],
		["border",[broderAttributes()]],
		["border-collapse",["collapse","inherit","separate"]],
		["border-color",[getRandomColor,"transparent","inherit"]],
		["border-spacing",[posdistanceValue1]],
		["border-style",["none","hidden","dotted","dashed","solid","double","groove","ridge","inset","outset"]],
		["border-top",[broderAttributes]],
		["border-right",[broderAttributes]],
		["border-bottom",[broderAttributes]],
		["border-left",[broderAttributes]],
		["border-top-color",[getRandomColor,"transparent","inherit"]],
		["border-right-color",[getRandomColor,"transparent","inherit"]],
		["border-bottom-color",[getRandomColor,"transparent","inherit"]],
		["border-left-color",[getRandomColor,"transparent","inherit"]],
		...
		["border-top-width",[pospxValue,"thin","thick","medium"]],
		["border-right-width",[pospxValue,"thin","thick","medium"]],
		["border-bottom-width",[pospxValue,"thin","thick","medium"]],
		["border-left-width",[pospxValue,"thin","thick","medium"]],
		["border-width",[pospxValue,"thin","thick","medium"]],
		["bottom",[distanceValue3,"inherit","auto",function(){return rint(ra(INT_NUMS))}]],
		...
		["color",[getRandomColor]],
		["content",[function() {return retCSSmediaURI(2000)},'open-quote','close-quote','no-open-quote','no-close-quote','inherit',"normal","none"]],
		["counter-increment",[function () { return string(rint(STR_NUM))+"a"},"inherit","none","initial"]],
		["counter-reset",[function () { return string(rint(STR_NUM))+"a "+rint(ra(INT_NUMS))},"inherit","none","initial"]],
		["css-float",["left","right","none","inherit"]],
		["cue",[function() {return retCSSmediaURI(2000)},"inherit"]],
		["cue-after",[function() {return retCSSmediaURI(2000)},"inherit"]],
		["cue-before",[function() {return retCSSmediaURI(2000)},"inherit"]],
		["cursor",[function() {return retmultiplecurs()},function() {return retcursorURI(1)},'auto','crosshair','pointer','alias','all-scroll','cell','context-menu',"col-resize","copy","default","e-resize","ew-resize","help","move","n-resize","ne-resize","nesw-resize","ns-resize","nw-resize","nwse-resize","no-drop","none","not-allowed","pointer","progress","row-resize","s-resize","se-resize","sw-resize","text","vertical-text","w-resize","wait","zoom-in","zoom-out","initial","inherit"]],//,"grab","grabbing"
		["direction",["ltr","rtl","inherit"]],
		["display",["inline","block","list-item","run-in","compact","marker","table","inline-table","table-row-group","table-header-group","table-footer-group","table-row","table-column-group","table-column","table-cell","table-caption","none","inherit","grid",'inline-grid']],
		["elevation",[angleValue,"below","level","above","higher","lower","inherit"]],
		...
		["float",["left","right","none","inherit"]],
		["font",[fontAtrribute,"caption","icon","menu","message-box","small-caption","status-bar","inherit"]],
		["font-family",[returnMultipleFamilies,"inherit"]],
		["font-size",["xx-small","x-small","small","medium","large","x-large","xx-large","larger","smaller",posdistanceValue1,posdistanceValue1,"inherit"]],
		["font-size-adjust",[randoms,"none","inherit"]],
		...
		["height",[posdistanceValue2,posdistanceValue2,"inherit","auto",function() {return rint(ra(POS_INT_NUMS))}]],//randoms
		["left",[distanceValue3,distanceValue3,"inherit","auto",function() {return rint(ra(INT_NUMS))}]],
		["letter-spacing",["normal",distanceValue2,"inherit",function() {return rint(ra(INT_NUMS))}]],
		["line-height",["normal",posdistanceValue1,"inherit",function() {return rint(ra(POS_INT_NUMS))}]],
		["list-style",[listStyleAttribute,"inherit"]],
		["list-style-image",[function() {return retCSSimageURI(2000)},"none","inherit"]],
		...
		["margin",[marginAttribute,"inherit"]],
		["margin-top",[distanceValue3,"inherit",function() {return rint(ra(INT_NUMS))}]],
		["margin-right",[distanceValue3,"inherit",function() {return rint(ra(INT_NUMS))}]],
		["margin-bottom",[distanceValue3,"inherit",function() {return rint(ra(INT_NUMS))}]],
		["margin-left",[distanceValue3,"inherit",function() {return rint(ra(INT_NUMS))}]],
		["marker-offset",[distanceValue,"inherit","auto",function() {return rint(ra(INT_NUMS))}]],
		["marks",["crop","cross","crop cross","cross crop","none","inherit"]],
		["max-height",[posdistanceValue1,"inherit","none",function() {return rint(ra(POS_INT_NUMS))}]],
		["max-width",[posdistanceValue1,function() {return rint(ra(POS_INT_NUMS))},"inherit","none"]],
		["min-height",[posdistanceValue1,function() {return rint(ra(POS_INT_NUMS))},"inherit"]],
		["min-width",[posdistanceValue1,function() {return rint(ra(POS_INT_NUMS))},"inherit"]],
		["orphans",[function() {return (rint(ra(POS_INT_NUMS))+1)},"inherit"]],
		["outline",[outlineAttribute,"inherit"]],
		["outline-color",[getRandomColor,"invert","inherit"]],
		["outline-style",["none","dotted","dashed","solid","double","groove","ridge","inset","outset","inherit"]],//,"hidden"
		["outline-width",[posdistanceValueblur,"thin","thick","medium","","inherit"]],//,function() {return rint(ra(POS_INT_NUMS))},
		["overflow",["visible","hidden","scroll","auto","inherit"]],
		["padding",[paddingAttribute,"inherit"]],
		["padding-top",[posdistanceValue1,function(){return rint(ra(POS_INT_NUMS))},"inherit"]],
		["padding-right",[posdistanceValue1,function(){return rint(ra(POS_INT_NUMS))},"inherit"]],
		["padding-bottom",[posdistanceValue1,function(){return rint(ra(POS_INT_NUMS))},"inherit"]],
		["padding-left",[posdistanceValue1,function(){return rint(ra(POS_INT_NUMS))},"inherit"]],
		["page",["","inherit"]], //more info needed
		["page-break-after",["auto","always","avoid","left","right","inherit"]],
		["page-break-before",["auto","always","avoid","left","right","inherit"]],
		["page-break-inside",["auto","avoid","inherit"]],
		["pause",[function() {return timeValue()},function() {return timeValue()+" "+ timeValue()},"inherit"]],
		["pause-after",[function() {return timeValue()},"inherit"]],
		["pause-before",[function() {return timeValue()},"inherit"]],
		["pitch",[freqValue,"x-low","low","medium","high","x-high","inherit"]],
		["pitch-range",[randoms,"inherit"]],
		["play-during",[function() {return retCSSmediaURI(2000)},function() {return retCSSmediaURI(2000)+" mix"},function() {return retCSSmediaURI(2000)+" repeat"},function() {return retCSSmediaURI(2000)+" mix repeat"},"auto","none","inherit"]],
		["position",["static","relative","absolute","fixed","inherit"]],
		// ["quotes",[]],
		["richness",[randoms,function(){return rint(ra(INT_NUMS))},"inherit"]],
		["right",[distanceValue3,"auto","inherit",function(){return rint(ra(INT_NUMS))}]],
		...
		["text-indent",[distanceValue3,distanceValue3,"inherit",function(){return rint(ra(INT_NUMS))}]],
		["text-shadow",[textShadowAttribute,"inherit","none","initial"]],
		["text-transform",["capitalize","uppercase","lowercase","none","inherit","initial"]],
		["top",[distanceValue3,"auto","inherit",function(){return rint(ra(INT_NUMS))}]],
		["unicode-bidi",["normal","embed","bidi-override","inherit"]],
		["vertical-align",[distanceValue3,distanceValue3,"baseline","sub","super","top","text-top","middle","bottom","text-bottom","inherit",function(){return rint(ra(INT_NUMS))}]],
		["visibility",["visible","hidden","collapse","inherit","initial"]],
		["voice-family",[voiceFamilyAttribute,"inherit"]],
		["volume",["inherit",function(){return rint(ra(INT_NUMS))},percentValue]],
		["white-space",["normal","pre","nowrap","inherit","pre-line","pre-wrap","initial"]],
		["widows",[function(){return (rint(ra(POS_INT_NUMS))+1)},"inherit",function(){return (rint(ra(POS_INT_NUMS))+1)}]],
		["width",[posdistanceValue2,function(){return rint(ra(POS_INT_NUMS))},"auto","inherit"]],
		["word-spacing",[distanceValue2,"normal","inherit",function(){return rint(ra(INT_NUMS))}]],
		["z-index",[function(){return rint(ra(INT_NUMS))},"inherit",function(){return rint(ra(INT_NUMS))}]],
		['opacity',[floatValue,"initial","inherit"]],
		['background-clip',['border-box','padding-box','content-box','initial','inherit']],
		['background-origin',['border-box','padding-box','content-box','initial','inherit']],
		['background-size',['contain','initial','inherit','cover','auto',function() {return distanceValue4()+" "+distanceValue4()},distanceValue4]],//,function() {return rint(2) ? rint(ra(INT_NUMS)):rint(ra(INT_NUMS))+' '+rint(ra(INT_NUMS))}
		['border-bottom-left-radius',['initial','inherit',function() {return posdistanceValueflex()+" "+posdistanceValueflex()},posdistanceValueflex]],//,function() {return rint(2) ? rint(ra(POS_INT_NUMS)):rint(ra(POS_INT_NUMS))+' '+rint(ra(POS_INT_NUMS))}
		['border-bottom-right-radius',['initial','inherit',function() {return posdistanceValueflex()+" "+posdistanceValueflex()},posdistanceValueflex]],//,function() {return rint(2) ? rint(ra(POS_INT_NUMS)):rint(ra(POS_INT_NUMS))+' '+rint(ra(POS_INT_NUMS))}
		['border-image-source',['none','initial','inherit',function() {return retCSSimageURI(2000)}]],
		['border-image-width',['initial','auto','inherit',posrnd4Lengths]],
		['border-image-outset',['initial','inherit',posrnd4Lengthsnoperc]],
		['border-image-repeat',['repeat','stretch','round','space','initial','inherit']],
		['border-image-slice',['initial','inherit',posrnd4nums]],//,'fill'
		['border-image',[function() {return  retCSSimageURI(2000)+' '+arrayWalk([pospercentValue,function() {return rint(ra(POS_INT_NUMS))},''])+' '+arrayWalk([pospercentValue,function() {return rint(ra(POS_INT_NUMS))},''])+' '+arrayWalk([pospercentValue,function() {return rint(ra(POS_INT_NUMS))},''])+' '+ra(['repeat','stretch','round','space',''])},'inherit','initial']],
		['border-top-left-radius',['initial','inherit',function() {return posdistanceValueflex()+" "+posdistanceValueflex()},posdistanceValueflex,]],//function() {return rint(2) ? rint(ra(POS_INT_NUMS)):rint(ra(POS_INT_NUMS))+' '+rint(ra(POS_INT_NUMS))}
		['border-top-right-radius',['initial','inherit',function() {return posdistanceValueflex()+" "+posdistanceValueflex()},posdistanceValueflex]],//,function() {return rint(2) ? rint(ra(POS_INT_NUMS)):rint(ra(POS_INT_NUMS))+' '+rint(ra(POS_INT_NUMS))}
		['border-radius',['initial','inherit',function() {return posrnd4Lengthsflex()+'/'+posrnd4Lengthsflex()}]],
		['box-shadow',['none','initial','inherit',function() {return posdistanceValueblur()+' '+posdistanceValueblur()+' '+posdistanceValueblur()+' '+ra([txtdistanceValue(),''])+' '+ra([getRandomColor(),''])+' '+ra(['inset',''])}]],
		['overflow-x',['visible','hidden','scroll','auto','initial','inherit']],
		['overflow-y',['visible','hidden','scroll','auto','initial','inherit']],
		['align-content',['stretch','center','flex-start','flex-end','space-between','space-around','initial','inherit']],
		['align-items',['stretch','center','flex-start','flex-end','baseline','initial','inherit']],
		['align-self',['stretch','center','flex-start','flex-end','baseline','initial','inherit','auto']],
		['flex-grow',[function() {return rint(ra(POS_INT_NUMS))},'initial','inherit']],
		['flex-shrink',[function() {return rint(ra(POS_INT_NUMS))},'initial','inherit']],
		['flex-basis',[posdistanceValueflex,'initial','inherit','auto']],
		['flex',[function() {return rint(ra(POS_INT_NUMS))+' '+ra([rint(ra(POS_INT_NUMS)),''])+' '+ra([posdistanceValueflex(),''])},function() {return rint(ra(POS_INT_NUMS))},'inherit','auto','initial','none']],
		['flex-direction',['row','row-reverse','column','column-reverse','initial','inherit']],
		['flex-wrap',['nowrap','wrap','wrap-reverse','initial','inherit']],
		['flex-flow',[function() {return ra(['row','row-reverse','column','column-reverse'])+" "+ra(['nowrap','wrap','wrap-reverse'])},'initial','inherit']],
		['justify-content',['flex-start','flex-end','center','space-between','space-around','initial','inherit']],
		['order',['inherit','initial',function() {return rint(ra(INT_NUMS))}]],
		['hanging-punctuation',['initial','inherit','none','first','last','allow-end','force-end']],
		['tab-size',[function() {return rint(ra(POS_INT_NUMS))},'initial','inherit']],
		['text-align-last',['auto','left','right','center','justify','start','end','initial','inherit']],
		['text-justify',['auto','distribute','none','initial','inherit']],//,'inter-word','inter-ideograph','inter-cluster','kashida','trim'
		['word-break',['normal','break-all','initial','inherit']],//,'keep-all'
		['word-wrap',['normal','break-word','initial','inherit']],
		['text-decoration-color',[getRandomColor,'initial','inherit']],
		['text-decoration-line',['none','underline','overline','line-through','initial','inherit']],
		['text-decoration-style',['solid','double','dotted','dashed','wavy','initial','inherit']],
		['animation-delay',[timeValue,'initial','inherit']],
		['animation-direction',['normal','reverse','alternate','alternate-reverse','initial','inherit']],
		['animation-duration',[timeValue,'initial','inherit']],
		['animation-fill-mode',['none','forwards','backwards','both','initial','inherit']],
		['animation-iteration-count',['infinite','initial','inherit',function() {return rint(ra(INT_NUMS))},randoms]],
		['animation-name',[function() {return "'"+string(rint(STR_NUM))+"'"},'none','inherit','initial']],
		['animation-timing-function',['linear','ease','ease-in','ease-out',function() {return 'cubic-bezier('+floatValue()+","+floatValue()+","+floatValue()+","+floatValue()+")"},'initial','inherit']],
		['animation-play-state',['paused','running','initial','inherit']],
		['animation',[function() {return arrayWalk([function() {return string(rint(STR_NUM))},'none'])+" "+timeValue()+" "+arrayWalk(['linear','ease','ease-in','ease-out',function() {return 'cubic-bezier('+floatValue()+","+floatValue()+","+floatValue()+","+floatValue()+")"},''])+" "+arrayWalk([timeValue,''])+" "+arrayWalk(['infinite',function() {return rint(ra(INT_NUMS))},randoms,''])+" "+ra(['normal','reverse','alternate','alternate-reverse',''])+" "+ra(['none','forwards','backwards','both',''])+ " "+ra(['paused','running',''])},'inherit','initial']],
		['backface-visibility',['visible','hidden','initial','initial']],
		['perspective',['none',posdistanceValueblur,'initial','inherit']],//,function() {return rint(ra(POS_INT_NUMS))}
		['perspective-origin',[function() {return arrayWalk(['left','center','right',distanceValue4])+" "+ arrayWalk(['top','center','bottom',distanceValue4])},'inherit','initial']],
		['transform-origin',[function() {return arrayWalk(['left','center','right',txtdistanceValue])+" "+ arrayWalk(['top','center','bottom',txtdistanceValue])+" "+txtdistanceValue()},'inherit','initial']],
		['transform-style',['flat','preserve-3d','initial','inherit']],
		['transform',[transformValue,'initial','inherit']],
		['transition-property',['none','all','initial','inherit',function() {return ra(CSS3SheetsPropertiesInterface.Attributes)[0]}]],
		['transition-duration',[timeValue,'initial','inherit']],
		['transition-timing-function',['linear','ease','ease-in','ease-out','ease-in-out',function() {return 'cubic-bezier('+floatValue()+","+floatValue()+","+floatValue()+","+floatValue()+")"},'initial','inherit']],
		['transition-delay',['initial','inherit',timeValue]],
		['transition',[function() {return arrayWalk(['none','all',function() {return ra(CSS3SheetsPropertiesInterface.Attributes)[0]}])+" "+timeValue()+" "+arrayWalk(['linear','ease','ease-in','ease-out','ease-in-out',function() {return 'cubic-bezier('+floatValue()+","+floatValue()+","+floatValue()+","+floatValue()+")"},''])+ " "+ra([timeValue(),''])},'initial','inherit']],
		['box-sizing',['content-box','border-box','initial','inherit']],
		['icon',[function() {return retCSSimageURI(2000)},'auto','initial','inherit']],
		['nav-down',['auto','initial','inherit',function() {return "#"+ra(createdElements).objName},function() {return rint(2) ? ra([returnRandomElement(),ra(createdText).objName,'createdElements['+ra(createdText).objName+']']):"'"+string(rint(STR_NUM))+"'"}]],
		['nav-index',[function() {return rint(ra(INT_NUMS))},randoms,'auto','initial','inherit']],
		['nav-left',['auto','initial','inherit',function() {return "#"+ra(createdElements).objName},function() {return rint(2) ? ra([returnRandomElement(),ra(createdText).objName,'createdElements['+ra(createdText).objName+']']):"'"+string(rint(STR_NUM))+"'"}]],
		['nav-right',['auto','initial','inherit',function() {return "#"+ra(createdElements).objName},function() {return rint(2) ? ra([returnRandomElement(),ra(createdText).objName,'createdElements['+ra(createdText).objName+']']):"'"+string(rint(STR_NUM))+"'"}]],
		['nav-up',['auto','initial','inherit',function() {return "#"+ra(createdElements).objName},function() {return rint(2) ? ra([returnRandomElement(),ra(createdText).objName]):"'"+string(rint(STR_NUM))+"'"}]],
		['outline-offset',[txtdistanceValue,'initial','inherit']],//,function(){return rint(ra(INT_NUMS))}
		['resize',['none','both','horizontal','vertical','initial','inherit']],
		['text-overflow',['clip','ellipsis','initial','inherit']],//,function() {return rint(ra(INT_NUMS))}
		['column-rule-style',['none','hidden','dotted','dashed','solid','double','groove','ridge','inset','outset','initial','inherit']],
		['column-rule-width',['medium','thin','thick','initial','inherit',distanceValue,function() {return rint(ra(INT_NUMS))}]],
		['column-span',['1','all','initial','inherit']],
		['column-width',['auto','inherit','initial',distanceValue,function() {return rint(ra(INT_NUMS))}]],
		['columns',['auto',function() {return arrayWalk(['auto','inherit','initial',distanceValue,function() {return rint(ra(INT_NUMS))}])+" "+ra([rint(ra(INT_NUMS))])},'initial','inherit']],
		['column-count',[function(){return rint(ra(INT_NUMS))},randoms,'auto','initial','inherit']],
		['column-fill',['balance','auto','initial','inherit']],
		['column-gap',[distanceValue,function() {return rint(ra(INT_NUMS))},'normal','initial','inherit']],
		['column-rule',[function() {return arrayWalk(['medium','thin','thick',distanceValue,function() {return rint(ra(INT_NUMS))}])+" "+arrayWalk(['none','hidden','dotted','dashed','solid','double','groove','ridge','inset','outset'])+" "+arrayWalk([getRandomColor])},'initial','inherit']],
		['column-rule-color',[getRandomColor,'initial','inherit']],
		['box-decoration-break',['slice','clone','initial','inherit','unset']],
		['hyphens',['none','manual','auto','inherit']],
		['overflow-wrap',['normal','break-word','inherit']],
		['text-combine-upright',['none','all',function() {return rint(ra(INT_NUMS))}]],
		['text-under-line-position',['auto','under','inherit']],//'left','right','under left','right under',
		['font-feature-settings',['normal','inherit',"'aaaa'","'aaaa '"+randbool(),"smcp","smcp "+randbool(),"swsh'","swsh "+randbool()]],
		['font-kerning',['auto','normal','none','initial','inherit','unset']],
		['font-language-override',['normal','initial','inherit','unset',ra(["ABA","ABK","ADY","AFK","AFR","AGW","ALS","ALT","AMH","APPH","ARA","ARI","ARK","ASM","ATH","AVR","AWA","AYM","AZE","BAD","BAG","BAL","BAU","BBR","BCH","BCR","BEL","BEM","BEN","BGR","BHI","BHO","BIK","BIL","BKF","BLI","BLN","BLT","BMB","BML","BOS","BRE","BRH","BRI","BRM","BSH","BTI","CAT","CEB","CHE","CHG","CHH","CHI","CHK","CHP","CHR","CHU","CMR","COP","COS","CRE","CRR","CRT","CSL","CSY","DAN","DAR","DCR","DEU","DGR","DHV","DIV","DJR","DNG","DNK","DRI","DUN","DZN","EBI","ECR","EDO","EFI","ELL","ENG","ERZ","ESP","ETI","EUQ","EVK","EVN","EWE","FAN","FAR","FIN","FJI","FLE","FNE","FON","FOS","FRA","FRI","FRL","FTA","FUL","GAD","GAE","GAG","GAL","GAR","GAW","GEZ","GIL","GMZ","GON","GRN","GRO","GUA","GUJ","HAI","HAL","HAR","HAU","HAW","HBN","HIL","HIN","HMA","HND","HO","HRI","HRV","HUN","HYE","IBO","IJO","ILO","IND","ING","INU","IPPH","IRI","IRT","ISL","ISM","ITA","IWR","JAV","JII","JAN","JUD","JUL","KAB","KAC","KAL","KAN","KAR","KAT","KAZ","KEB","KGE","KHA","KHK","KHM","KHS","KHV","KHW","KIK","KIR","KIS","KKN","KLM","KMB","KMN","KMO","KMS","KNR","KOD","KOH","KOK","KON","KOP","KOR","KOZ","KPL","KRI","KRK","KRL","KRM","KRN","KRT","KSH","KSI","KSM","KUI","KUL","KUM","KUR","KUU","KUY","KYK","LAD","LAH","LAK","LAM","LAO","LAT","LAZ","LCR","LDK","LEZ","LIN","LMA","LMB","LMW","LSB","LSM","LTH","LTZ","LUB","LUG","LUH","LUO","LVI","MAJ","MAK","MAL","MAN","MAP","MAR","MAW","MBN","MCH","MCR","MDE","MEN","MIZ","MKD","MLE","MLG","MLN","MLR","MLY","MND","MNG","MNI","MNK","MNX","MOH","MOK","MOL","MON","MOR","MRI","MTH","MTS","MUN","NAG","NAN","NAS","NCR","NDB","NDG","NEP","NEW","NGR","NHC","NIS","NIU","NKL","NKO","NLD","NOG","NOR","NSM","NTA","NTO","NYN","OCI","OCR","OJB","ORI","ORO","OSS","PAA","PAL","PAN","PAP","PAS","PGR","PIL","PLG","PLK","PRO","PTG","QIN","RAJ","RCR","RBU","RIA","RMS","ROM","ROY","RSY","RUA","RUS","SAD","SAN","SAT","SAY","SEK","SEL","SGO","SHN","SIB","SID","SIG","SKS","SKY","SLA","SLV","SML","SMO","SNA","SND","SNH","SNK","SOG","SOT","SQI","SRB","SRK","SRR","SSL","SSM","SUR","SVA","SVE","SWA","SWK","SWZ","SXT","SYR","TAB","TAJ","TAM","TAT","TCR","TEL","TGN","TGR","TGY","THA","THT","TIB","TKM","TMN","TNA","TNE","TNG","TOD","TRK","TSG","TUA","TUL","TUV","TWI","UDM","UKR","URD","USB","UYG","UZB","VEN","VIT","WA","WAG","WCR","WEL","WLF","XBD","XHS","YAK","YBA","YCR","YIC","YIM","ZHH","ZHP","ZHS","ZHT","ZND","ZUL"])]],
		['font-synthesis',['none','weight','style','weight style','initial','inherit','unset']],
		['font-variant-alternates',['normal','historical-forms','initial','inherit','unset',function() {return ra(['stylistic','styleset','character-variant','swash','ornaments','annotation'])+"("+ra([rint(ra(INT_NUMS)),randoms()])+")"},function() {return "swash("+ra([rint(ra(INT_NUMS)),randoms()])+") annotation("+ra([rint(ra(INT_NUMS)),randoms()])+")"}]],
		...
		['font-variant-east-asian',['normal','ruby','jis78','jis83','jis90','jis04','simplified','traditional','full-width','proportional-width','ruby '+ra(['full-width','proportional-width']+" "+ra(['jis78','jis83','jis90','jis04','simplified','traditional']))]],
		...
		['font-variant-position',['normal','sub','super','initial','inherit','unset']],
		['writing-mode',['rl-tb','lr','lr-tb','rl','tb-rl']],//'horizontal-tb','vertical-lr','vertical-rl','bt-rl','bt-lr','lr-bt','rl-bt','tbtb-lr'
		...
		['filter',["url(data:image/svg+xml;base64,)",'none']],//,"blur("+ra([distanceValue(),rint(ra(INT_NUMS))])+")"
		['image-orientation',['from-image','flip','inherit',angleValue,function() {return angleValue()+" flip"}]],
		['image-rendering',['auto','pixelated','inherit']],//,'crisp-edges'
		['image-resolution',['from-image','from-image snap',function() {return rint(2) ? rint(ra(INT_NUMS))+ra(["dpi","dpcm"]):randoms()+ra(["dpi","dpcm"])},function() {return rint(2) ? rint(ra(INT_NUMS))+ra(["dpi","dpcm"]):randoms()+ra(["dpi","dpcm"])+" snap"}]],
		['object-fit',['fill','contain','cover','none','scale-down']],
		['object-position',[distanceValue4]],
		['mask',["url(data:image/svg+xml;base64,)",'none','inherit']],
		['mask-type',['luminance','alpha']],
		['mark-after',[function() {return "'"+string(rint(STR_NUM))+"'"},function() {return ra([returnRandomElement(),ra(createdText).objName,'createdElements['+ra(createdText).objName+']'])}]],
		['mark-before',[function() {return "'"+string(rint(STR_NUM))+"'"},function() {return ra([returnRandomElement(),ra(createdText).objName,'createdElements['+ra(createdText).objName+']'])}]],
		['mark',[function() {return arrayWalk([function() { return "'"+string(rint(STR_NUM))+"'"},ra(createdText).objName,returnRandomElement,'createdElements['+ra(createdText).objName+']'])+" "+arrayWalk([function() {return "'"+string(rint(STR_NUM))},returnRandomElement,'createdElements['+ra(createdText).objName+']'])}]],
		['rest-after',[timeValue,'none','x-weak','weak','medium','strong','x-strong']],
		['rest-before',[timeValue,'none','x-weak','weak','medium','strong','x-strong']],	
		['rest',[arrayWalk([timeValue,'none','x-weak','weak','medium','strong','x-strong'])+" "+arrayWalk([timeValue,'none','x-weak','weak','medium','strong','x-strong'])]]	,
		['voice-balance',['left','center','right','leftwards','rightwards',function() {return rint(ra(INT_NUMS))}]],
		['voice-duration',['auto',timeValue]],
		['voice-pitch',[freqValue,function() {return freqValue()+" "+ra(["absolute",'x-low','low','high','x-high','medium'])}]],
		['voice-range',[freqValue,function() {return freqValue()+" "+ra(["absolute",'x-low','low','high','x-high','medium'])}]],
		['voice-stress',['normal','strong','moderate','none','reduced']],
		['voice-rate',['normal','x-slow','slow','medium','fast','x-fast',percentValue]],
		['voice-volume',['silent','x-soft','soft','medium','loud','x-loud',function() {return ra([rint(ra(INT_NUMS)),'-'+rint(ra(INT_NUMS))])+"db"}]],
		['marquee-direction',['auto','backwards','left','forwards','right','reverse','down','ahead','up']],
		['marquee-play-count',[function() {return rint(ra(INT_NUMS))},'infinite']],
		['marquee-speed',['fast','normal','slow',function() {return rint(ra(INT_NUMS))}]],
		['marquee-style',['alternate','none','scroll','slide']],
		['float',['left','right','none','inherit']],
		['clear',['left','right','none','inherit','both']],
		['all',['initial','inherit','unset']],
		['shape-outside',[shape]],
		['shape-image-threshold',[function() {return rint(ra(INT_NUMS))},floatValue]],
		['shape-margin',[posdistanceValue2]],
		['grid-row',[function() {return zrint(ra(INT_NUMS))},function() {return zrint(ra(INT_NUMS))+'/'+zrint(ra(INT_NUMS))}]],
		['grid-column',[function() {return zrint(ra(INT_NUMS))},function() {return zrint(ra(INT_NUMS))+'/'+zrint(ra(INT_NUMS))}]],
	]
}
...
ElementInterface = {
	...
	'Methods': [
		['getAttribute',[function() {return '"'+ra(ra(createdElements).object.Attributes)[0]+'"'}],''],
		['setAttribute',[function() {return "'"+ra(ra(createdElements).object.Attributes)[0]+"',"+ra([rint(ra(INT_NUMS)),randoms(),"''","'"+string(rint(STR_NUM))+"'"])}],'high'],
		['removeAttribute',[function() {return "'"+ra(ra(createdElements).object.Attributes)[0]+"'"},'""'],'high'],
		['getAttributeNode',[function() {return '"'+ra(ra(createdElements).object.Attributes)[0]+'"'},'""'],''],
		['setAttributeNode',[function() {var elem = ra(createdElements); return elem.objName+'.getAttributeNode("'+ra(elem.object.Attributes)[0]+'")'}],'high'],//,function() {var elem = ra(createdElements); return elem.objName+'.getAttribute("")'}
		['removeAttributeNode',[function() {var elem = ra(createdElements); return elem.objName+'.getAttributeNode("'+ra(elem.object.Attributes)[0]+'")'}],'high'],//function() {var elem = ra(createdElements); return elem.objName+'.getAttribute("")'}
		['getElementsByTagName',[function() {return '"'+ra(createdElements).object.tagName+'"'},'""'],''],
		['getAttributeNS',[function(){return rint(2) ? '"http://www.w3.org/1999/xhtml","'+ra(ra(createdElements).object.Attributes)[0]+'"':'"http://www.w3.org/1999/xhtml",""'}],''],
		['setAttributeNS',[function() {return "'http://www.w3.org/1999/xhtml','"+ra(ra(createdElements).object.Attributes)[0]+"',"+ra([rint(ra(INT_NUMS)),randoms(),"'"+string(rint(STR_NUM))+"'","''"])}],''],//:'"","",""'
		['removeAttributeNS',[function(){return rint(2) ? '"http://www.w3.org/1999/xhtml","'+ra(ra(createdElements).object.Attributes)[0]+'"':'"http://www.w3.org/1999/xhtml",""'}],''],//:'"",""'
		['getAttributeNodeNS',[function(){return rint(2) ? '"http://www.w3.org/1999/xhtml","'+ra(ra(createdElements).object.Attributes)[0]+'"':'"http://www.w3.org/1999/xhtml",""'},function(){return rint(2) ? '"","'+ra(ra(createdElements).object.Attributes)[0]+'"':'"",""'}],''],
		// WORKMORE ['setAttributeNodeNS',[function() {var elem = ra(createdElements); return elem.objName+'.getAttribute("'+ra(elem.object.Attributes)[0]+'")'}]],//function() {return '"http://www.w3.org/1999/xhtml","'+ra(ra(createdElements).object.Attributes)[0]+'"'},'"",""',"","null,null",function() {var elem = ra(createdElements); return '"http://www.w3.org/1999/xhtml",'+elem.objName+'.getAttribute("'+ra(elem.object.Attributes)[0]+'")'},function() {var elem = ra(createdElements); return '"",'+elem.objName+'.getAttribute("'+ra(elem.object.Attributes)[0]+'")'},function() {var elem = ra(createdElements); return '"http://www.w3.org/1999/xhtml",""'}
		['getElementsByTagNameNS',[function() {return '"http://www.w3.org/1999/xhtml","'+ra(createdElements).object.tagName+'"'}],''],
		['hasAttribute',[function() {return '"'+ra(ra(createdElements).object.Attributes)[0]+'"'},'""'],''],
		['hasAttributeNS',[function() {return '"http://www.w3.org/1999/xhtml","'+ra(ra(createdElements).object.Attributes)[0]+'"'},'"http://www.w3.org/1999/xhtml",""'],''],
		// ['setIdAttribute',[function() {return '"'+ra(ra(createdElements).object.Attributes)[0]+'",'+randbool()},function() {return '"'+ra(ra(createdElements).object.Attributes)[0]+'",""'},function() {return '"'+ra(ra(createdElements).object.Attributes)[0]+'",'+rint(ra(INT_NUMS))},'"",""']],
		// ['setIdAttributeNS',[function() {return '"http://www.w3.org/1999/xhtml","'+ra(ra(createdElements).object.Attributes)[0]+'",'+randbool()},function() {return '"http://www.w3.org/1999/xhtml","'+ra(ra(createdElements).object.Attributes)[0]+'",""'},function() {return '"","'+ra(ra(createdElements).object.Attributes)[0]+'",'+rint(ra(INT_NUMS))},'"","",""',function() {return '"","'+ra(ra(createdElements).object.Attributes)[0]+'",'+randbool()}]],
		// ['setIdAttributeNode',[function() {return '"'+ra(ra(createdElements).object.Attributes)[0]+'",'+randbool()},function() {return '"'+ra(ra(createdElements).object.Attributes)[0]+'",""'},function() {return '"'+ra(ra(createdElements).object.Attributes)[0]+'",'+rint(ra(INT_NUMS))},'"",""',function() {return 'document.createAttribute("'+ra(ra(createdElements).object.Attributes)[0]+'"),'+randbool()},function() {return 'document.createAttribute("'+ra(ra(createdElements).object.Attributes)[0]+'"),'+rint(99999999)},function() {return 'document.createAttribute("'+ra(ra(createdElements).object.Attributes)[0]+'"),'+randoms()}]]
	].concat(NodeInterface.Methods)
}
...
DocumentInterface = {
	...
	'Methods':[
		...
		['createAttribute',[function(){return '"'+ra(ra(createdElements).object.Attributes)[0]+'"'}],''],//,'""'
		...
		['createAttributeNS',[function() {return '"http://www.w3.org/1999/xhtml","'+ra(ra(createdElements).object.Attributes)[0]+'"'}],''],
		['getElementsByTagNameNS',[function(){return '"http://www.w3.org/1999/xhtml","'+ra(createdElements).object.tagName+'"'}],''],
		['getElementById',[function(){return '"'+ra(createdElements).object.tagName+'"'}],''],
		...
		// ['normalizeDocument',['']],
		// ['renameNode',[function(){return ra(createdElements).object.tagName+',"http://www.w3.org/1999/xhtml","'+string(rint(STR_NUM))+'"'},function(){return ra(createdElements).object.tagName+',"http://www.w3.org/1999/xhtml",""'},function(){return ra(createdElements).object.tagName+',"",""'},function(){return {},"",""}]],
		['createRange',[''],''],
		// ['createTextRange',['']],
...
HTMLDocumentInterface = {
	...
	'Methods':[
		...
		['getElementsByName',[function() {return rint(2) ? '"'+ra(createdElements).object.tagName+'"':'""'}],''],
...
HTMLSelectElementInterface = {
	...
	'Methods':[
		['add',[function() {return rint(2) ? null:randoms()},function() {return rint(2) ? "document.createElement('option')":"document.createElement('optgroup')"}, function() {return rint(2) ? "document.getElementsByTagName('option')[0]":"document.getElementsByTagName('optgroup')[0]"},function() {return rint(2) ? "document.createElement('"+ra(createdElements).object.tagName+"')":"document.createElement('"+ra(ElementArray)[0].tagName+"')"},function() {return rint(2) ? ra([returnRandomElement(),ra(createdText).objName,'createdElements['+ra(createdText).objName+']']):''}],'high'],
...
HTMLCanvasElementInterface = {
	...
	'Methods':[
		...
		['toBlob',[function() {return rint(2) ? 'function(){},"'+ra(mimeTypes)+'"':'"","'+ra(mimeTypes)+'","'+floatValue()+'"'},'function(){},"",""','function() {}','"","",""','',function() {var elem= ra(createdElements); var method = ra(elem.object.Methods); return rint(2) ? 'function(){'+ra([elem.objName,'createdElements['+elem.objName+']'])+'.'+method[0]+'('+arrayWalk(method[1])+')},"'+ra(mimeTypes)+'"':'"","'+ra(mimeTypes)+'","'+floatValue()+'"'},function() {var elem= ra(createdElements); var method = ra(elem.object.Methods); return 'function(){'+ra([elem.objName,'createdElements['+elem.objName+']'])+'.'+method[0]+'('+arrayWalk(method[1])+')},"",""'},function() {var elem= ra(createdElements); var method = ra(elem.object.Methods); return 'function() {'+ra([elem.objName,'createdElements['+elem.objName+']'])+'.'+method[0]+'('+arrayWalk(method[1])+')}'}],'high']
	].concat(HTMLElementInterface.Methods),
	'tagName':'CANVAS',
	'style':HTMLElementInterface.style
}
...
HTMLObjectElementInterface = {
	...
	'Attributes':[
		...
		['name',[function() {return rint(2) ? string(rint(STR_NUM)):''}],''],
		['useMap',[function() {var returnString = '';var hash='#';returnString+=hash+ra([returnRandomElement]);return returnString},'#',''],'high'],
		['form',[function() {return rint(2) ? "document.createElement('FORM')":"document.getElementsByTagName('FORM')[0].id"},function() {return ra([returnRandomElement(),ra(createdText).objName,'createdElements['+ra(createdText).objName+']'])},''],'readonly'],
...
NodeIteratorInterface = {
	...
	'Attributes':[
		...
		['filter',[function() {return "{acceptNode:"+ra(['NodeFilter.FILTER_ACCEPT','NodeFilter.FILTER_REJECT','NodeFilter.FILTER_SKIP','NodeFilter.FILTER_REJECT',randoms()])+"}"}],'readonly'],
...
function createTextNodes(num){
	...
	while(num--){
		...
		returnArray = returnArray.concat("createdElements['"+objName+init+"']="+objName+init)
		createdText.push({'objName':objName+init,'type':obj.Name, 'object':obj})
...
// 	console.log(createdElements.length)
	var attrib =ra(e.object.style.Attributes)
	returnArray=returnArray.concat(ra([e.objName,'createdElements['+e.objName+']'])+'.style.'+attrib[0]+'="'+arrayWalk(attrib[1]))+'"'
	return returnArray
}
...
function fuzzStyle1() {
	...
	var returnString = ''
	var prob = rint(100)
	var selector = ra([ra(createdElements).object.tagName,'#'+ra(createdElements).objName,'*',ra(createdElements).object.tagName+","+ra(createdElements).object.tagName])
	while(rounds--) {
		var attrib =ra(CSS3SheetsPropertiesInterface.Attributes)
		returnString += attrib[0]+": "+arrayWalk(attrib[1])+"; " 
	}
	if(prob>15 || !stweak){
...
function fuzzElementsAttribs() {
	...
	var attrib = ra(elem.object.Attributes)
	if ((attrib[2] == 'readonly' || attrib[2] != 'high') && rint(20)) {
		fuzzElementsAttribs()
	}
...
function fuzzElementsMethods() {
	...
	var mtd = ra(elem.object.Methods)
	if ((mtd[2] != 'high') && rint(20)) {
		fuzzElementsMethods()
	}
...
function crossRef() {
	...
	var HTMLelements = [
		...
		['replaceChild',[function(){return ra([returnRandomElement(),"document.createElement('"+ra(ElementArray)[0].tagName+"')",ra(createdText).objName,'createdElements['+ra(createdText).objName+']'])+','+returnRandomElement()}]],
